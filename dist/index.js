...
var ye = (e, t, n) => t in e ? ge(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n;
var b = (e, t, n) => ye(e, typeof t != "symbol" ? t + "" : t, n);
import { useDark as ve } from "@vueuse/core";
import { ref as E, onMounted as K, onBeforeUnmount as _e, defineComponent as F, h as L, createApp as be, nextTick as Q, computed as W, watch as we, createVNode as M, Fragment as xe } from "vue";
import { onBeforeRouteLeave as Se } from "vue-router";
const ut = (e) => typeof e == "string", ft = (e) => typeof e == "number", ht = (e) => typeof e == "object", mt = (e) => typeof e == "function", pt = (e) => Array.isArray(e), gt = (e) => typeof e == "boolean", yt = (e) => e === null, vt = (e) => e === void 0, _t = (e) => e instanceof RegExp, bt = (e) => e instanceof Promise, wt = (e) => e instanceof Date, xt = (e) => e == null, St = (e) => /^http[s]?:\/\/.*/.test(e), Et = (e) => /^[a-zA-Z0-9_-]+@[a-zA-Z0-9_-]+(\.[a-zA-Z0-9_-]+)+$/.test(e), Dt = (e) => /^0?(13[0-9]|15[012356789]|18[0-9]|14[123578]|16[6]|17[035768]|19[19])[0-9]{8}$/.test(e), Mt = (e) => /^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$/.test(e), Lt = (e) => /^[\u4e00-\u9fa5]{0,}$/.test(e), Ct = (e) => /^[a-zA-Z]+$/.test(e), Tt = (e) => /^[A-Za-z0-9]+$/.test(e), Pt = (e) => /^[A-Za-z0-9_]+$/.test(e), $t = (e) => /^[A-Z]+$/.test(e), It = (e) => /^[a-z]+$/.test(e), Rt = (e) => /^(400|800)([0-9\\-]{7,10})|(([0-9]{4}|[0-9]{3})([- ])?)?([0-9]{7,8})(([- 转])*([0-9]{1,4}))?$/.test(e), At = (e) => /^([0-9]|[1-9]\d|[1-9]\d{2}|[1-9]\d{3}|[1-5]\d{4}|6[0-4]\d{3}|65[0-4]\d{2}|655[0-2]\d|6553[0-5])$/.test(e), kt = (e) => e == null || e === "" || e === 0 || e === !1 || Array.isArray(e) && e.length === 0 || typeof e == "object" && Object.keys(e).length === 0;
async function Ee(e) {
  try {
...
class Le {
  constructor(t, n = {}) {
    ...
    this.gl = i, this.resizeCanvas(), this.program = this.initProgram(n.vertexShaderSource || De, n.fragmentShaderSource || Me);
  }
  // 更新片段着色器
...
class Nt extends Le {
  // 控制渲染的标志
  constructor(n, r) {
    super(n, { vertexShaderSource: Ce, fragmentShaderSource: r });
    b(this, "startTime");
    b(this, "endTime");
...
class Bt {
  ...
  static format(t = /* @__PURE__ */ new Date(), n = "YYYY-MM-DD HH:mm:ss") {
    ...
    if (!this.isValid(r))
      return "Invalid Date";
    const s = (v, y = 2) => v.toString().padStart(y, "0"), i = r.getFullYear(), o = r.getMonth() + 1, a = r.getDate(), d = r.getHours(), l = r.getMinutes(), m = r.getSeconds(), p = r.getMilliseconds(), u = d >= 12 ? "PM" : "AM", f = d % 12 || 12, c = {
      YYYY: i.toString(),
  ...
  static humanize(t, n = {}) {
    const {
      ...
      showSuffix: o = !0
    } = n, a = t instanceof Date ? t : new Date(t), d = i instanceof Date ? i : new Date(i);
    if (!this.isValid(a))
      return "Invalid Date";
    const l = d.getTime() - a.getTime(), m = Math.abs(l);
    if (m > r)
    ...
    for (const { unit: u, ms: f, past: c, future: v } of p)
      if (m >= f) {
        const y = Math.floor(m / f), _ = o ? l >= 0 ? c : v : u;
        return `${y}${_}`;
      }
  ...
  static diff(t, n = /* @__PURE__ */ new Date()) {
    ...
    const i = s.getTime() - r.getTime(), o = Math.sign(i), a = Math.abs(i) / 1e3, d = a / 60, l = d / 60, m = l / 24;
    let p = s.getFullYear() - r.getFullYear(), u = s.getMonth() - r.getMonth(), f = s.getDate() - r.getDate();
    if (f < 0) {
      u--;
    ...
    return u < 0 && (p--, u += 12), {
      years: o * Math.abs(p),
      // 符号化年差
      months: o * Math.abs(p * 12 + u),
      // 符号化总月差
      days: o * Math.floor(m),
      // 符号化天差（基于24小时制）
      hours: o * Math.floor(l),
      // 符号化小时差
      minutes: o * Math.floor(d),
      // 符号化分钟差
...
function Te(e, t, n) {
  const r = [[0, 360]], s = [[50, 100]], i = [[30, 70]], o = e && e.length > 0 ? e : r, a = t && t.length > 0 ? t : s, d = n && n.length > 0 ? n : i, l = (f) => {
...
function Pe(e, t, n) {
  ...
  let o = 0, a = 0, d = 0;
  0 <= e && e < 60 ? (o = r, a = s, d = 0) : 60 <= e && e < 120 ? (o = s, a = r, d = 0) : 120 <= e && e < 180 ? (o = 0, a = r, d = s) : 180 <= e && e < 240 ? (o = 0, a = s, d = r) : 240 <= e && e < 300 ? (o = s, a = 0, d = r) : 300 <= e && e < 360 && (o = r, a = 0, d = s);
  const l = (m) => {
    const p = Math.round((m + i) * 255).toString(16);
    return p.length === 1 ? "0" + p : p;
  };
  return `#${l(o)}${l(a)}${l(d)}`.toUpperCase();
}
class Ht {
  /**
   * 生成随机字符串
...
const Ut = () => {
  ...
  return { isDark: e, toggleTheme: async (n, r = !1) => {
    ...
    try {
      ...
      }), await d.finished, e.value = !e.value;
    } catch {
      e.value = !e.value;
    }
  } };
  ...
  const t = (o) => {
    ...
    const a = o.value, d = (u) => {
      ...
      var f;
      u.preventDefault(), a.classList.remove("drag-active"), (f = e == null ? void 0 : e.dragCallback) == null || f.call(e, u);
    };
    return a.addEventListener("dragover", d), a.addEventListener("dragenter", l), a.addEventListener("dragleave", m), a.addEventListener("drop", p), () => {
      a.removeEventListener("dragover", d), a.removeEventListener("dragenter", l), a.removeEventListener("dragleave", m), a.removeEventListener("drop", p);
    };
  }, r = (o) => new Promise((a, d) => {
    const l = t(o);
    l.style.display = "none";
    const m = setTimeout(() => {
      d(new Error("选择取消或超时")), document.body.removeChild(l);
    }, 3e4);
    l.onchange = (p) => {
      clearTimeout(m);
      const u = p.target.files;
      u != null && u.length ? a(u) : d(new Error("未选择文件")), document.body.removeChild(l);
...
function T(e, t = {}) {
  var l, m, p;
  const n = { ...$e, ...t };
  e.style.transition = `filter ${n.duration}s ease, opacity ${n.duration}s ease`, e.style.filter = `blur(${n.blurAmount}px)`, e.style.opacity = "0", e.parentElement && !["relative", "absolute", "fixed", "sticky"].includes(getComputedStyle(e.parentElement).position) && (e.parentElement.style.position = "relative"), X(Ie), n.placeholder && typeof n.placeholder == "object" && n.placeholder.style && X(n.placeholder.style);
  ...
  let i = null;
  n.placeholder && !n.thumbnail && (i = j("placeholder", n.placeholder), i.classList.add("blur-fade-in-placeholder"), (p = e.parentElement) == null || p.insertBefore(i, e));
  const o = () => {
    var u, f;
    i == null || i.remove(), (f = (u = e.parentElement) == null ? void 0 : u.querySelector(".blur-fade-in-error")) == null || f.remove(), e.offsetWidth, e.style.filter = "blur(0)", e.style.opacity = "1", e.removeEventListener("load", o), e.removeEventListener("error", a);
  }, a = () => {
    var u, f;
    if (console.error("Image failed to load", e.src), i == null || i.remove(), (f = (u = e.parentElement) == null ? void 0 : u.querySelector(".blur-fade-in-error")) == null || f.remove(), n.errorImage)
  ...
  function d() {
    ...
    if (e.style.filter = "blur(0)", e.style.opacity = "1", n.placeholder) {
      const f = j("error", n.placeholder);
      f.classList.add("blur-fade-in-error"), (u = e.parentElement) == null || u.insertBefore(f, e);
    }
  }
...
const Re = {
  ...
  mounted: function(e) {
    e.style.cursor = "move", e.style.position = "absolute", e.onmousedown = function(t) {
      ...
      document.onmousemove = function(s) {
        let i = s.pageX - n, o = s.pageY - r, a = parseInt(window.getComputedStyle(e.parentNode).width) - parseInt(window.getComputedStyle(e).width), d = parseInt(window.getComputedStyle(e.parentNode).height) - parseInt(window.getComputedStyle(e).height);
        i < 0 ? i = 0 : i > a && (i = a), o < 0 ? o = 0 : o > d && (o = d), e.style.left = i + "px", e.style.top = o + "px";
  ...
  __proto__: null,
  default: Oe
}, Symbol.toStringTag, { value: "Module" })), ee = F({
  name: "LoadingOverlay",
  props: {
    text: {
      type: String,
...
const Ye = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  mounted(e, t) {
    ...
    const o = ((H = t.value) == null ? void 0 : H.minWidth) ?? 50, a = ((U = t.value) == null ? void 0 : U.minHeight) ?? 50;
    let d = !1, l = null, m = 0, p = 0, u = 0, f = 0, c = 0, v = 0, y = 0, _ = 0, S = 0, w = 0;
    const I = () => ({
      left: 0,
      top: 0,
      right: i.clientWidth,
      ...
      h.preventDefault(), h.stopPropagation(), d = !0, l = g, m = h.clientX, p = h.clientY, u = e.offsetWidth, f = e.offsetHeight, c = e.offsetLeft, v = e.offsetTop, y = u, _ = f, S = c, w = v, document.addEventListener("mousemove", Y), document.addEventListener("mouseup", B);
    }, Y = (h) => {
      if (!d || !l) return;
      const g = h.clientX - m, D = h.clientY - p, x = I();
      switch (l) {
        case "top-left":
          y = Math.max(o, u - g), _ = Math.max(a, f - D), S = c + (u - y), w = v + (f - _);
          break;
        case "top-right":
          y = Math.max(o, u + g), _ = Math.max(a, f - D), w = v + (f - _);
          break;
        case "bottom-left":
          y = Math.max(o, u - g), _ = Math.max(a, f + D), S = c + (u - y);
          break;
        case "bottom-right":
          y = Math.max(o, u + g), _ = Math.max(a, f + D);
          break;
      }
      S < x.left && (S = x.left, l.includes("left") && (y = u + c - x.left)), w < x.top && (w = x.top, l.includes("top") && (_ = f + v - x.top)), S + y > x.right && (y = x.right - S), w + _ > x.bottom && (_ = x.bottom - w), y = Math.max(o, y), _ = Math.max(a, _), fe();
    }, B = () => {
      d && (d = !1, e.style.width = `${y}px`, e.style.height = `${_}px`, e.style.left = `${S}px`, e.style.top = `${w}px`, he(), document.removeEventListener("mousemove", Y), document.removeEventListener("mouseup", B));
    };
    s.forEach((h, g) => {
      var V;
      const D = ["top-left", "top-right", "bottom-left", "bottom-right"], x = (pe) => me(pe, D[g]);
      h.addEventListener("mousedown", x), (V = e.__resizeListeners) == null || V.push({ mousedown: x });
    });
  },
  unmounted(e) {
  ...
  __proto__: null,
  createContainer: ne
}, Symbol.toStringTag, { value: "Module" })), re = (e, t, n, r, s) => {
  ...
  __proto__: null,
  createRippleElement: re
}, Symbol.toStringTag, { value: "Module" }));
function C(e, t, n, r) {
  const s = e - n, i = t - r;
  return Math.sqrt(s * s + i * i);
}
function se(e, { width: t, height: n, left: r, top: s }) {
  const i = e.clientX - r, o = e.clientY - s, a = C(i, o, 0, 0), d = C(i, o, t, 0), l = C(i, o, 0, n), m = C(i, o, t, n), p = Math.max(a, d, l, m);
  return {
    x: i,
    y: o,
    diameter: p
...
const Xe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getDistanceToFurthestCorner: se,
  getPythagoreanDistance: C
}, Symbol.toStringTag, { value: "Module" })), N = "vRippleCountInternal";
function ie(e, t) {
  e.dataset[N] = t.toString();
}
function $(e) {
  return parseInt(e.dataset[N] ?? "0", 10);
}
function oe(e) {
  const t = $(e);
  ie(e, t + 1);
...
const qe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  deleteRippleCount: le,
  getRippleCount: $,
  incrementRippleCount: oe
}, Symbol.toStringTag, { value: "Module" })), Ge = 1.05, A = /* @__PURE__ */ new WeakMap(), Ze = { ...te }, Je = (e, t, n) => {
  const r = t.getBoundingClientRect(), s = window.getComputedStyle(t), { diameter: i, x: o, y: a } = se(e, r), d = ne(s), l = re(o, a, i * Ge, n, r);
  let m = "", p = !1, u;
  function f() {
    l.style.transition = "opacity 120ms ease in out", l.style.opacity = "0", setTimeout(() => {
      d.remove(), ae(t), $(t) === 0 && (le(t), t.style.position = m);
    }, 100);
  }
  function c(y) {
  ...
  function v() {
    clearTimeout(u), d.remove(), document.removeEventListener("pointerup", c), document.removeEventListener("pointercancel", c), document.removeEventListener("pointercancel", v);
  }
  oe(t), s.position === "static" && (t.style.position && (m = t.style.position), t.style.position = "relative"), d.appendChild(l), t.appendChild(d), document.addEventListener("pointerup", c), document.addEventListener("pointercancel", c), u = setTimeout(() => {
  ...
  mounted(e, t) {
    A.set(e, t.value ?? {}), e.addEventListener("pointerdown", (n) => {
      var s;
      const r = A.get(e);
      (s = t.value) != null && s.disabled || r !== !1 && Je(n, e, {
        ...Ze,
        ...r
      });
    });
  ...
  __proto__: null,
  default: Ke
}, Symbol.toStringTag, { value: "Module" })), q = 50, G = 500, ce = /* @__PURE__ */ new WeakMap(), et = (e) => {
  const t = new IntersectionObserver((n) => {
    for (const r of n)
      if (r.isIntersecting) {
        const s = ce.get(r.target);
        s && s.play(), t.unobserve(e);
      }
  });
  t.observe(e);
}, tt = (e, t) => e.getBoundingClientRect().top - t > window.innerHeight, nt = {
  mounted(e, t) {
    let n = q, r = G;
    if (typeof t.value == "number" ? n = t.value : t.value && typeof t.value == "object" && (n = t.value.distance ?? q, r = t.value.duration ?? G), !tt(e, n))
      return;
    const s = e.animate(
      [
    ...
    s.pause(), ce.set(e, s), et(e);
  }
}, rt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: nt
}, Symbol.toStringTag, { value: "Module" })), Z = /* @__PURE__ */ Object.assign({ "./blur-fade-in/index.ts": Ae, "./blur-fade-in/types.ts": ke, "./draggable/index.ts": ze, "./loading/index.ts": Ye, "./loading/loading.ts": Fe, "./loading/types.ts": Be, "./resize/index.ts": Ue, "./ripple/index.ts": Qe, "./ripple/options.ts": Ve, "./ripple/utils/create-container-element.ts": We, "./ripple/utils/create-ripple-element.ts": je, "./ripple/utils/get-element-position-utils.ts": Xe, "./ripple/utils/ripple-count.ts": qe, "./slide-in/index.ts": rt }), Xt = {
  install: function(e) {
    for (const t in Z) {
      const n = Z[t].default;
      if (!n) continue;
...
}, st = "C", it = "cl", z = (e) => `${it}__${e}`, de = (e) => `${st}${e || ""}`, k = F({
  name: "Icon",
  props: {
    /**
     * 图标类型
  ...
  render() {
    const { type: e, size: t, color: n, name: r, spin: s } = this, i = z(`${e}-icon`), o = s ? z(`${e}-icon-spin`) : "";
    return e === "svg" ? L(
      "svg",
      {
        class: [i, o],
  ...
  setup(e, {
    ...
    const r = z("segmented"), s = E(null), i = E(null), o = E(-1), a = E(!1), d = W(() => e.options.findIndex((c) => c.value === e.value)), l = (c) => {
      ...
      if (c && (y.style.transition = "none"), y.style.width = `${w.width}px`, y.style.height = `${w.height}px`, y.style.left = `${w.left - S.left}px`, !c && o.value !== -1 && d.value !== -1) {
        const I = d.value > o.value ? "right" : "left";
        y.classList.remove(`${r}-thumb-left`, `${r}-thumb-right`), y.classList.add(`${r}-thumb-${I}`);
      }
...
export {
  ...
  Bt as Time,
  zt as addEventListen,
  Ee as copyToClipboard,
  Ot as copyToClipboardWithCallback,
  Ct as isAlpha,
  Tt as isAlphaNum,
  Pt as isAlphaNumUnderline,
  pt as isArray,
  kt as isBlank,
  gt as isBoolean,
  Lt as isChinese,
